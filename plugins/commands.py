...
from pyrogram import Client as Mr_zod
...
@Mr_zod.on_message(filters.command('id') & (filters.private | filters.group))
...
@Mr_zod.on_message(filters.command('info') & (filters.private | filters.group))
...
@Mr_zod.on_message((filters.private | filters.group) & filters.command('status'))
...
@Mr_zod.on_message(filters.command('start') & filters.private)
...
@Mr_zod.on_message(filters.command('help') & filters.private)
    ...
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    I
                    InlineKeyboardButton("Support Group", url="https://t.me/Ohkeithen")
                ]
            ]
        ),
        reply_to_message_id=message.message_id
...
@Mr_zod.on_message(filters.command('about') & filters.private)
            ...
            [
                [
                    InlineKeyboardButton(
                        "SOURCE CODE", url="https://github.com/ikrums/owlzefilter")
                ],
                [
